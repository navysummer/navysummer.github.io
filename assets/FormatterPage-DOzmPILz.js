import{b as m,a as i,t as S,k as h,p as g,o as p,F as C,n as T,c as v,r as E,u as N}from"./vendor-DJAHsOyX.js";import{_}from"./index-BNj57DdA.js";const u=(n,t)=>new Array(t+1).join(n),y=n=>{try{const t=JSON.parse(n);return JSON.stringify(t,null,2)}catch(t){return"JSON解析失败: "+t.message+`
...
`)},O=n=>L(n),M=n=>{const r=n.replace(/\s+/g," ").replace(/\{/g,`{
`).replace(/\}/g,`
}
`).replace(/;/g,`;
`).split(`
...
`)},b=n=>n.replace(/;+/g,";"),x=n=>n.replace(/\{/g,`{
`).replace(/\}/g,`
}
`).replace(/;/g,`;
`),l=n=>{const t=x(b(n)).split(`

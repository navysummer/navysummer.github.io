...
`)}}},C={class:"xml-wrap"},O={class:"topbar"},E={class:"actions"},L={class:"content"},A={class:"pane"},X={class:"pane"},F={class:"result"};function R(i,t,s,o,r,e){return M(),D("div",C,[m("div",O,[t[8]||(t[8]=m("div",null,"XML 工具",-1)),m("div",E,[t[6]||(t[6]=m("label",{class:"lbl"},"类/结构名",-1)),g(m("input",{"onUpdate:modelValue":t[0]||(t[0]=n=>r.name=n),class:"input",placeholder:"例如 Root"},null,512),[[j,r.name]]),t[7]||(t[7]=m("label",{class:"lbl"},"目标",-1)),g(m("select",{"onUpdate:modelValue":t[1]||(t[1]=n=>r.target=n),class:"input"},[...t[5]||(t[5]=[x('<option value="json" data-v-1e971ca4> json </option><option value="java" data-v-1e971ca4> java类 </option><option value="c" data-v-1e971ca4> c结构体 </option><option value="cpp" data-v-1e971ca4> C++类 </option><option value="python" data-v-1e971ca4> Python类 </option><option value="rust" data-v-1e971ca4> Rust结构体 </option><option value="go" data-v-1e971ca4> go结构体 </option><option value="ts" data-v-1e971ca4> ts类 </option><option value="toon" data-v-1e971ca4> Toon </option><option value="csharp" data-v-1e971ca4> C#类 </option><option value="yaml" data-v-1e971ca4> yaml </option><option value="dart" data-v-1e971ca4> dart类 </option><option value="xmlschema" data-v-1e971ca4> xml schema </option><option value="swift" data-v-1e971ca4> swift类 </option><option value="objc" data-v-1e971ca4> object-c类 </option><option value="ruby" data-v-1e971ca4> ruby类 </option><option value="kotlin" data-v-1e971ca4> kotlin类 </option><option value="php" data-v-1e971ca4> PHP类 </option><option value="sql" data-v-1e971ca4> sql </option><option value="toml" data-v-1e971ca4> toml </option>',20)])],512),[[S,r.target]]),m("button",{class:"btn",onClick:t[2]||(t[2]=(...n)=>e.onConvert&&e.onConvert(...n))}," 转换 "),m("button",{class:"btn",onClick:t[3]||(t[3]=(...n)=>e.onCopy&&e.onCopy(...n))}," 复制 ")])]),m("div",L,[m("div",A,[t[9]||(t[9]=m("h3",null,"输入 XML",-1)),g(m("textarea",{"onUpdate:modelValue":t[4]||(t[4]=n=>r.input=n),class:"editor",placeholder:'<user id="1"><name>navy</name></user>'},null,512),[[j,r.input]])]),m("div",X,[t[10]||(t[10]=m("h3",null,"输出",-1)),m("pre",F,[m("code",{ref:"code",class:N("hljs language-"+e.codeLang)},w(e.codeText),3)])])])])}const V=P(T,[["render",R],["__scopeId","data-v-1e971ca4"]]);export{V as default};

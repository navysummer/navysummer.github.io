import{b as r,a as e,k as d,p as u,q as c,F as p,n as m,o as i,t as h}from"./vendor-yjUBYCCz.js";import{_ as g}from"./index-QnCXKXJ2.js";const v={data(){return{title:"RunJS",mode:"js",code:"",logs:[],html:"",css:"",js:""}},computed:{placeholder(){return this.mode==="js"?'console.log("Hello World")':'<h1>Hello</h1><script>document.body.style.color="red"<\/script>'}},mounted(){document.title=this.title,window.addEventListener("message",this.onMsg)},unmounted(){window.removeEventListener("message",this.onMsg)},methods:{clearAll(){this.code="",this.logs=[];const o=this.$refs.preview;o&&o.contentWindow&&(o.srcdoc="")},onMsg(o){const s=o.data;!s||s.type!=="runjs-log"||this.logs.push(s.payload)},run(){const o=this.$refs.preview;if(!o)return;const s=`

import{o as r,b as d,a as e,z as i,C as u,D as c,F as p,j as m,t as h}from"./vendor-BJAQRKHk.js";import{_ as g}from"./index-CtfK80iT.js";const v={data(){return{title:"RunJS",mode:"js",code:"",logs:[],html:"",css:"",js:""}},computed:{placeholder(){return this.mode==="js"?'console.log("Hello World")':'<h1>Hello</h1><script>document.body.style.color="red"<\/script>'}},mounted(){document.title=this.title,window.addEventListener("message",this.onMsg)},unmounted(){window.removeEventListener("message",this.onMsg)},methods:{clearAll(){this.code="",this.logs=[];const o=this.$refs.preview;o&&o.contentWindow&&(o.srcdoc="")},onMsg(o){const s=o.data;!s||s.type!=="runjs-log"||this.logs.push(s.payload)},run(){const o=this.$refs.preview;if(!o)return;const s=`

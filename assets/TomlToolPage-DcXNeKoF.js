...
${r}
);`}}},M={class:"toml-wrap"},C={class:"topbar"},O={class:"actions"},L={class:"content"},E={class:"pane"},A={class:"pane"},R={class:"result"};function F(i,t,s,o,r,e){return v(),D("div",M,[m("div",C,[t[8]||(t[8]=m("div",null,"TOML 工具",-1)),m("div",O,[t[6]||(t[6]=m("label",{class:"lbl"},"类/结构名",-1)),k(m("input",{"onUpdate:modelValue":t[0]||(t[0]=n=>r.name=n),class:"input",placeholder:"例如 Root"},null,512),[[g,r.name]]),t[7]||(t[7]=m("label",{class:"lbl"},"目标",-1)),k(m("select",{"onUpdate:modelValue":t[1]||(t[1]=n=>r.target=n),class:"input"},[...t[5]||(t[5]=[x('<option value="json" data-v-e81715f2> json </option><option value="java" data-v-e81715f2> java类 </option><option value="c" data-v-e81715f2> c结构体 </option><option value="cpp" data-v-e81715f2> C++类 </option><option value="python" data-v-e81715f2> Python类 </option><option value="rust" data-v-e81715f2> Rust结构体 </option><option value="go" data-v-e81715f2> go结构体 </option><option value="ts" data-v-e81715f2> ts类 </option><option value="toon" data-v-e81715f2> Toon </option><option value="csharp" data-v-e81715f2> C#类 </option><option value="yaml" data-v-e81715f2> yaml </option><option value="dart" data-v-e81715f2> dart类 </option><option value="xmlschema" data-v-e81715f2> xml schema </option><option value="swift" data-v-e81715f2> swift类 </option><option value="objc" data-v-e81715f2> object-c类 </option><option value="ruby" data-v-e81715f2> ruby类 </option><option value="kotlin" data-v-e81715f2> kotlin类 </option><option value="php" data-v-e81715f2> PHP类 </option><option value="sql" data-v-e81715f2> sql </option>',19)])],512),[[S,r.target]]),m("button",{class:"btn",onClick:t[2]||(t[2]=(...n)=>e.onConvert&&e.onConvert(...n))}," 转换 "),m("button",{class:"btn",onClick:t[3]||(t[3]=(...n)=>e.onCopy&&e.onCopy(...n))}," 复制 ")])]),m("div",L,[m("div",E,[t[9]||(t[9]=m("h3",null,"输入 TOML",-1)),k(m("textarea",{"onUpdate:modelValue":t[4]||(t[4]=n=>r.input=n),class:"editor",placeholder:'name = "navy"\\n[user]\\nid = 1'},null,512),[[g,r.input]])]),m("div",A,[t[10]||(t[10]=m("h3",null,"输出",-1)),m("pre",R,[m("code",{ref:"code",class:T("hljs language-"+e.codeLang)},w(e.codeText),3)])])])])}const W=P(N,[["render",F],["__scopeId","data-v-e81715f2"]]);export{W as default};
